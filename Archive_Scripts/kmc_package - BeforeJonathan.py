#H5PY removed from the Array Class - From 26/01/2017 to 06/04/17 (before Jonathan's analysis)
...
def save_evolution(f, obj):
	...
	dset_doubleFreq.attrs['attempt_freq'] = obj.input_attemptFreq
	...
	dset_singleFreq.attrs['attempt_freq'] = obj.input_attemptFreq
